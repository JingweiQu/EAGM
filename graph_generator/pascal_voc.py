...
class PascalVOC:
    def __init__(self, sets, obj_resize):
        ...
        """
        self.classes = cfg.VOC2011.CLASSES # PascalVOC类别数
        self.kpt_len = [len(KPT_NAMES[_]) for _ in cfg.VOC2011.CLASSES] # 每个类的最多keypoint数

        self.classes_kpts = {cls: len(KPT_NAMES[cls]) for cls in self.classes} # 类别与其最多keypoint数一一对应
