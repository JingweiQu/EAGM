...
GRAPH_INDEX_FIELDS = (RECEIVERS, SENDERS, GROUP_INDICES_1,GROUP_INDICES_2)
GRAPH_NUMBER_FIELDS = (N_NODE, N_EDGE, N_GROUP_1, N_GROUP_2)

GRAPH_FEATURE_FIELDS = (NODES, NODES2, EDGES, EDGES2, GLOBALS, GROUPS_1, GROUPS_2)
GRAPH_DATA_FIELDS = (NODES, NODES2, EDGES, EDGES2, RECEIVERS, SENDERS, GLOBALS, GROUP_INDICES_1, GROUP_INDICES_2, GROUPS_1, GROUPS_2)
ALL_FIELDS = (NODES, NODES2, EDGES, EDGES2, RECEIVERS, SENDERS, GLOBALS, N_NODE, N_EDGE, N_GROUP_1, GROUP_INDICES_1, GROUPS_1, N_GROUP_2, GROUP_INDICES_2, GROUPS_2)
